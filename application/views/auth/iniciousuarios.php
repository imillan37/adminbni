  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <span class="d-block d-lg-none">BNI TOLUCA</span>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="Auth/logout">Salir</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container-fluid p-0">
      <!--REVISAR LA SECCION SIGUIENTE:-->
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto"><?php echo form_input($first_name);?>
          <h1 class="mb-0"><?php echo htmlspecialchars($users->last_name,ENT_QUOTES,'UTF-8');?>
            <span class="text-primary"><?php echo form_input($first_name);?></span>
          </h1>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="empresa">
        <div class="my-auto">
